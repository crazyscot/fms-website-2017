...
<html>
  <head>
    ...
    <title>Fencing Mid-South trophies and awards - The Secondary School Womens Foil Team Trophy</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>The Secondary School Womens Foil Team Trophy</h1>
				<a href="../images/Frank Hogg Trophy.jpg" target="_blank">
					<img src="../images/Frank Hogg Trophy - small.jpg" alt="Frank Hogg Trohpy">
				</a>
				<p>The Secondary School Womens Foil Team Trophy...</p>
				<p></p>
				<h2>Trophy Holders</h2>
				<table>
					<tr>
						<td>2016</td> <td>Not awarded</td>
					</tr>
					<tr>
						<td>2015</td> <td>Cashmere High School</td>
					</tr>
					<tr>
						<td>2014</td> <td>???</td>
					</tr>
