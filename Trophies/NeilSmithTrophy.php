...
<html>
  <head>
    ...
    <title>Fencing Mid-South trophies and awards - Neil Smith Trophy</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>The Neil Smith Trophy</h1>
				<a href="./images/NeilSmith.JPG" target="_blank">
					<img src="./images/NeilSmith1_sm.JPG" alt="Neil Smith Trohpy">
				</a>
				<p  class="trophy-engraving">The Neil Smith Trophy <br>
				Mens Sabre <br>
				Canterbury U20</p>
				...
				<table>
					...
					<tr>
						<td>2004</td> <td>J. Chan</td>
					</tr>
					<tr>
						<td>2003</td> <td>J. Chan</td>
					</tr>
					<tr>
						<td>2002</td> <td>J. Tabak</td>
					</tr>
					<tr>
						<td>2001</td> <td>J. Chan</td>
					</tr>
				</table>
			</div>
		</div>
