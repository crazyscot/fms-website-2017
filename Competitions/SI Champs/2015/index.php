...
<html>
  <head>
    ...
    <title>Fencing Mid-South Competitions - South Island Champs - 2015</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>South Island Champs 2015</h1>
				<h1>Notices</h1>
				<div class="trophy">
					<?php include './Notices/SIChamps_2015_notices.php'; ?>
				</div>
				<hr>
				<h1>Results</h1>
				<div class="trophy">
				<p> 
					<a href="/Results/SouthIslandChamps2015/index.htm" target="_blank">Detailed competition results</a> 
