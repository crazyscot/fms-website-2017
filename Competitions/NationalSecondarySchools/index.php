    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>National Secondary Schools</h1>
				<p>
					The National Secondary Schools competition is a FENZ comptition, not a Mid-South competition. Each of the four 
				...
				<p>
					The competition is open to anybody who is in years 9 to 13 at either a secondary school, or correspondence
          school, or is home schooled. It includes all three weapons, split into male and female. In addition there are
          teams events. 
				</p>
				<h2>Seasons</h2>
				<ul>
