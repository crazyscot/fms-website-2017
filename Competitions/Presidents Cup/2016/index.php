...
<html>
  <head>
    ...
    <title>Fencing Mid-South Competitions - Presidents Cup - 2016</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>Presidents Cup 2016</h1>
				<h1>Notices</h1>
				<p>
					This year the Presidents Cup is being run with the NZ Veteran Foil, and the NZ Under 23 Sabre.
				</p>
				<div class="trophy">
					<?php include './Notices/presidents_cup_2016.php'; ?>
				</div>
				<hr>
				<h1>Results</h1>
				<div class="trophy">
				<p>
                      <a target="_blank" title="Presidents Cup 2016 detailed scores" href="./Results/index.htm">
						Live scores
						</a> from pools and DE rounds.
				</p>
				<p>
                      Final summarised results:
				</p>
				</div>
			</div>
		</div>
