...
<html>
  <head>
    ...
    <title>Fencing Mid-South Competitions - Primary and Intermediate Schools - 2018</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>Mid South Primary and Intermediate Schools 2018</h1>
				<h1>Notices</h1>
					<?php include './Notices/MSPrimaryInt2018.php'; ?>
				<hr>
				<h1>Results</h1>
				<p>
