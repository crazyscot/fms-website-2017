...
<html>
  <head>
    ...
    <title>Fencing Mid-South Competitions - Autumn Cup - 2017</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>The Autumn Cup 2017</h1>
				<h1>Notices</h1>
				<div class="trophy">
					<?php include './Notices/20170302.php'; ?>
				</div>
				<hr>
				<h1>Results</h1>
				<div class="trophy">
					<p><a href="./Results/index.htm" target="_blank">Live results available here</a></p>
				</div>
			</div>
		</div>
      </div>
