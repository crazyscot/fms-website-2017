...
<html>
  <head>
    ...
    <title>Fencing Mid-South Competitions - NZ National Open, and Veteran Champs</title>
    <!--[if lt IE 9]>
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				...
				<p>
					The National Open and the Veteran Champs are both FENZ comptitions, not Mid-South competitions. Each of the four 
					fencing regions takes turns at hosting these events, so Mid-South will only host them every few years.
				</p>
				<p>
					These are both the highest level competitions for their age groups in NZ, drawing competitors from around the country.
				</p>
				<h2>Trophies</h2>
				<h2>Seasons</h2>
				<ul>
