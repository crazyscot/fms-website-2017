...
<html>
  <head>
    ...
    <title>Fencing Mid-South Competitions - Mid South Open - 2018</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>Mid South Open 2018</h1>
				<h1>Notices</h1>
				<hr>
				<h1>Results</h1>
				<div class="trophy">
                      <a target="_blank" title="Mid South Open 2018 results" href="./Results/index.htm">Live results available here</a><br>
				</div>
			</div>
		</div>
      </div>
