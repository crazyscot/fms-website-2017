...
<html>
  <head>
    ...
    <title>Fencing Mid-South Competitions - Midwinter Cup - 2018</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>Midwinter Cup 2018</h1>
				<h1>Notices</h1>
				<div class="trophy">
					<?php include './Notices/MidwinterCup2018.php'; ?>
				</div>
				<hr>
				<h1>Results</h1>
					<p><a href="http://www.fencingmidsouth.org.nz/Competitions/MidWinter Cup/2018/Results/" target="_blank">Full results will be available here.</a></p>
			</div>
		</div>
      </div>
      <br>
