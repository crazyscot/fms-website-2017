...
<html>
  <head>
    ...
    <title>Fencing Mid-South Competitions - Canterbury Schools - 2017</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>Canterbury Schools 2017</h1>
				<h1>Notices</h1>
				<div class="trophy">
				</div>
				<hr>
				<h1>Results</h1>
					<p><a href="http://www.fencingmidsouth.org.nz/Competitions/CanterburySchoolsComp/2017/Results/" target="_blank">Full results are now available here.</a></p>
			</div>
		</div>
      </div>
      <br>
