...
<html>
  <head>
    ...
    <title>Fencing Mid-South Competitions - Olga Jekyll Foil Teams - 2016</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>Olga Jekyll Foil Teams 2016</h1>
				<h1>Notices</h1>
					<p><?php include './Notices/olga_jekyll_notice_2016.php'; ?> </p>
				<hr>
				<h1>Results</h1>
				<div class="trophy">
					<p>
                      <a href="./Results/OlgaJekyll2016Results.pdf" target="_blank"> Results are now available.</a>
					</p>
 				</div>
			</div>
		</div>
