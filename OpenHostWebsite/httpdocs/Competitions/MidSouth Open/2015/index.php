...
<html>
  <head>
    ...
    <title>Fencing Mid-South Competitions - Mid South Open - 2015</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>Mid South Open 2015</h1>
				<h1>Notices</h1>
				<div class="trophy">
					<?php include './Notices/midsouth_open_notice_20150901.php'; ?>
				</div>
				<hr>
				<h1>Results</h1>
				<div class="trophy">
                      <a target="_blank" title="Mid South Open 2015 results" href="./Results/index.htm">Mid South Open 2015 Results</a><br>
				</div>
			</div>
		</div>
      </div>
