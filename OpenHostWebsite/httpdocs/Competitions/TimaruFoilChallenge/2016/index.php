...
<html>
  <head>
    ...
    <title>Fencing Mid-South Competitions - Timaru Foil Challenge - 2016</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>Timaru Foil Challenge 2016</h1>
				<h1>Notices</h1>
				<div class="trophy">
					<?php include './Notices/TimaruFoilChallenge2016_notices.php'; ?>
				</div>
				<hr>
				<h1>Results</h1>
				<div class="trophy">
