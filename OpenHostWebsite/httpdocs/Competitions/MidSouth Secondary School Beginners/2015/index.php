...
<html>
  <head>
    ...
    <title>Fencing Mid-South Competitions - Mid South Secondary School Beginners Foil - 2015</title>
    <!--[if lt IE 9]>
    ...
    <div class="page-container">
      ...
      <div class="wrapper">
        ...
        <div class="main-0 main-1">
			<div class="trophy">
				<h1>Mid South Secondary School Foil Beginners 2015</h1>
				<h1>Notices</h1>
				<div class="trophy">
					<?php include './Notices/secondary_school_beginners_notice_2015.php'; ?>
				</div>
				<hr>
				<h1>Results</h1>
				<div class="trophy">
				  <ul>
					<li><a target="_blank" href="./Results/Beginners & Intermediate Secondary School Champs 2015 Boy's Foil.htm">Boys Foil</a></li>
					<li><a target="_blank" href="./Results/Beginners & Intermediate Secondary School Champs 2015 Women's Foil.htm">Girls Foil</a></li>
				  </ul>
				</div>
			</div>
		</div>
